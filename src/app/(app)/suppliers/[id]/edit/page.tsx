...
import { getSupplierById, updateSupplier, type Supplier } from "@/services/suppliers";
  ...
  const fetchSupplier = useCallback(async () => {
    ...
    try {
      ...
      if (supplierData) {
        form.reset({
            ...supplierData,
            balanceDate: supplierData.balanceDate ? new Date(supplierData.balanceDate) : undefined,
        });
      } else {
      ...
      toast({ variant: 'destructive', title: 'Error', description: 'Failed to fetch supplier details.' });
    } finally {
      setLoading(false);
    }
        ...
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-muted-foreground">Update the profile for {form.getValues('name')}.</p>
                </div>
            ...
            <div className="space-y-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Update the details for the supplier.</CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-6">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                <FormLabel>Supplier Name / Company *</FormLabel>
                                <FormControl>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription className="flex items-center gap-2">
                            ...
                            Optionally, set a previous balance for this supplier.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                             <FormField
                                ...
                                render={({ field }) => (
                                    ...
                                    <p className="text-xs text-muted-foreground">Positive if you owe the supplier, negative if they owe you.</p>
                                    <FormMessage />
                                    </FormItem>
                                )}
                                />
